...
class ManageScreen extends StatelessWidget {
          ...
          children: [
            ...
            const SizedBox(height: 50),
             DashboardButton(
                ...
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => ManagePharmacistsScreen()));
                },
              ),
              ...
              DashboardButton(
                ...
                suffixIcon: IconAssets.arrowForward,
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => ManageMedicinesScreen()));
                },
              ),
            ...
            // _manageTile(context, "Manage Medicines", Icons.medical_services, ManageMedicinesScreen()),
            // _manageTile(context, "Manage Orders", Icons.shopping_cart, ManageOrdersScreen()),
          ],
        ),
      ),
    );
  ...
  Widget _manageTile(BuildContext context, String title, IconData icon, Widget screen) {
    return ListTile(
      leading: Icon(icon),
      title: Text(title),
